...
def test_manual_job_prefetches_complete_months_and_reports_result(monkeypatch, capsys) -> None:
    ...
    monkeypatch.setattr(sync_agenda, "build_database", lambda settings: object())
    monkeypatch.setattr(sync_agenda, "build_agenda_repository", lambda database: repository)
